...
<head>
	<meta charset="utf-8">
	<title>SQL Create Query Generator | DBHandler</title>
...
<div id="Page">
        ...
        <div id="Content">
        	<div id="q_typeHead">CREATE QUERY GENERATOR</div>
          	<div id="q_typeSubHead">Please provide us some basic information so that we can generate <strong>SQL Create</strong> query for you.</div>
            <br />
