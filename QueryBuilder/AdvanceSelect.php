...
<head>
	<meta charset="utf-8">
	<title>Advance Select Query Generator | DBHandler</title>
...
<div id="Page">
        ...
        <div id="Content">
        	<div id="q_typeHead">ADVANCE SELECT QUERY GENERATOR</div>
          	<div id="q_typeSubHead">Please provide us some basic information so that we can generate <strong>Advance Select</strong> query for you.</div>
            <br />
